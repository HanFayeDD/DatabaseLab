...
// 文件是否在打开列表中
bool DiskManager::is_file_open(const std::string &path) { return path2fd_.find(path) != path2fd_.end(); }
...
// 根据fd判断文件是否关闭
bool DiskManager::is_file_close(int fd) { return fd2path_.find(fd) == fd2path_.end(); }
